...
var stmtMap = {
    FunctionDef: function (n) { return scope(function () {
    ...
    ClassDef: function (n) { return scope(function () {
        setupScope(n);
...
function stmt(e) {
    ...
    if (cmts.length) {
        r = B.mkGroup(cmts.map(function (c) { return B.H.mkComment(c); }).concat(r));
    }
    return r;
}
function isEmpty(b) {
...
function convertAsync(fns) {
    ...
    for (var _i = 0, files_1 = files; _i < files_1.length; _i++) {
        var f = files_1[_i];
        for (var _a = 0, _b = ["/docs/conf.py", "/conf.py", "/setup.py", "/README.md", "/README.rst"]; _a < _b.length; _a++) {
            var suff = _b[_a];
