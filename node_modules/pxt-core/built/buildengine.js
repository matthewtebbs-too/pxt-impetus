...
function buildDalConst(buildEngine, mainPkg, force) {
    ...
    if (mainPkg && mainPkg.getFiles().indexOf(constName) >= 0 &&
        ...
        if (mainPkg.config.dalDTS) {
            for (var _i = 0, _a = mainPkg.config.dalDTS.includeDirs; _i < _a.length; _i++) {
                var dn = _a[_i];
        ...
        // stabilize
        for (var _d = 0, files_3 = files; _d < files_3.length; _d++) {
            var fn = files_3[_d];
            extractConstants(fn, fc[fn]);
        }
        var consts = "// Auto-generated. Do not edit.\ndeclare const enum DAL {\n";
        for (var _e = 0, files_4 = files; _e < files_4.length; _e++) {
            var fn = files_4[_e];
