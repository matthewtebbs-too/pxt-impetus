...
declare namespace ts.pxtc.Util {
    ...
    function downloadSimulatorLocalizationAsync(targetId: string, baseUrl: string, code: string, pxtBranch: string, targetBranch: string, live?: boolean): Promise<pxt.Map<string>>;
    function downloadTranslationsAsync(targetId: string, simulator: boolean, baseUrl: string, code: string, pxtBranch: string, targetBranch: string, live?: boolean): Promise<pxt.Map<string>>;
...
declare namespace pxt {
    ...
    function outputName(trg?: CompileTarget): "binary.cs" | "binary.uf2" | "binary.elf" | "binary.hex";
...
declare namespace pxt.docs {
    ...
    var requireMarked: () => typeof marked;
...
declare namespace ts.pxtc {
    ...
    const NATIVE_TYPE_AVR = "AVR";
    const NATIVE_TYPE_CS = "C#";
    const NATIVE_TYPE_AVRVM = "AVRVM";
