...
(function (pxsim) {
    ...
    var PerspectiveCamera = (function (_super) {
        ...
        function PerspectiveCamera(id) {
            ...
            _this.reference.position.set(-40, 20, 15);
            return _this;
        }
...
(function (pxsim) {
    var Geometry = (function (_super) {
        ...
        Object.defineProperty(Geometry.prototype, "btCollisionShape", {
            get: function () {
        ...
        Object.defineProperty(Geometry.prototype, "volumeOfShape", {
            get: function () {
                return this._volume;
            },
            enumerable: true,
        ...
        Object.defineProperty(Geometry.prototype, "_halfExtents", {
            get: function () {
        ...
        Object.defineProperty(Geometry.prototype, "_radius", {
            get: function () {
        ...
        Geometry.prototype._initFrom = function (btshape, volume) {
            btshape.setMargin(Geometry.collisionMargin);
            this._volume = volume;
            return this._btshape = btshape;
        };
        Geometry.prototype._initFromRadius = function (btshapeCtor, volumeCalc) {
            return this._initFrom(btshapeCtor(this._radius), volumeCalc(this._radius));
        };
        Geometry.prototype._initFromHalfExtents = function (btshapeCtor, volumeCalc) {
            var btvecHalfExtents;
            var btshape = btshapeCtor(btvecHalfExtents = pxsim.Helper.btVector3FromThree(this._halfExtents));
            pxsim.Helper.safeAmmoDestroy(btvecHalfExtents);
    ...
    var PlaneGeometry = (function (_super) {
        ...
        function PlaneGeometry(width, height, id) {
            ...
            _this._initFromHalfExtents(function (xts) { return new Ammo.btBoxShape(xts); }, function (xts) { return 0; });
            return _this;
        }
    ...
    var BoxGeometry = (function (_super) {
        ...
        function BoxGeometry(width, height, depth, openEnded, id) {
            ...
            var h = height || 1;
            var d = depth || 1;
            _this = _super.call(this, new THREE.BoxGeometry(w, h, d), id) || this;
            _this._initFromHalfExtents(function (xts) { return new Ammo.btBoxShape(xts); }, function (xts) { return xts.x * xts.y * xts.z; });
            return _this;
        }
        return BoxGeometry;
    }(Geometry));
    ...
    var CylinderGeometry = (function (_super) {
        ...
        function CylinderGeometry(radius, height, openEnded, id) {
            ...
            var r = radius || .5;
            var h = height || 1;
            _this = _super.call(this, new THREE.CylinderGeometry(r, r, h, Geometry.radialSegments, 1, openEnded || false), id) || this;
            _this._initFromHalfExtents(function (xts) { return new Ammo.btCylinderShape(xts); }, function (xts) { return Math.PI * Math.pow(r, 2) * xts.y; });
            return _this;
        }
    ...
    var SphereGeometry = (function (_super) {
        ...
        function SphereGeometry(radius, id) {
            var _this = this;
            var r = radius || .5;
            _this = _super.call(this, new THREE.SphereGeometry(r, Geometry.radialSegments, Geometry.radialSegments), id) || this;
            _this._initFromRadius(function (_r) { return new Ammo.btSphereShape(r); }, function (_r) { return 4 / 3 * Math.PI * Math.pow(r, 3); });
            return _this;
        }
    ...
    var ConeGeometry = (function (_super) {
        ...
        function ConeGeometry(radius, height, id) {
            ...
            var r = radius || .5;
            var h = height || 1;
            _this = _super.call(this, new THREE.ConeGeometry(r, h, Geometry.radialSegments), id) || this;
            _this._initFrom(new Ammo.btConeShape(r, h), Math.PI * Math.pow(r, 2) * h / 3);
            return _this;
        }
        return ConeGeometry;
    }(Geometry));
...
(function (pxsim) {
    ...
    var AmbientLight = (function (_super) {
        ...
        function AmbientLight(color, intensity, id) {
            return _super.call(this, new THREE.AmbientLight(color || 16777215, intensity || 1), id) || this;
        }
        return AmbientLight;
    }(Light));
...
(function (pxsim) {
    var Mesh = (function (_super) {
        ...
        Object.defineProperty(Mesh.prototype, "isRigidBody", {
            get: function () {
                return !!this._btbody;
            },
            set: function (yes) {
        ...
        Object.defineProperty(Mesh.prototype, "rigidbody", {
            get: function () {
                return this._btbody;
            },
            enumerable: true,
        ...
        Mesh.prototype._getMotionState = function (btmotionstate) {
            var bttransform = new Ammo.btTransform();
            var btorigin, btquarternion;
            bttransform.setOrigin(btorigin = pxsim.Helper.btVector3FromThree(this.reference.position));
            bttransform.setRotation(btquarternion = pxsim.Helper.btQuaternionFromThree(this.reference.quaternion));
        ...
        Mesh.prototype._setKinematicObject = function (isKinematic) {
            if (!this._btbody) {
                return;
            }
        ...
        Mesh.prototype._syncFromMotionState = function () {
            if (!this._btbody || this._btbody.isStaticOrKinematicObject()) {
                return;
            }
            var bttransform = new Ammo.btTransform();
            var btmotionstate = this._btbody.getMotionState();
            if (btmotionstate) {
        ...
        Mesh.prototype._configureRigidBody = function () {
            var mass = Math.max(Mesh.minMass, Math.min(Mesh.maxMass, this._geometry.volumeOfShape * this._material.density));
        ...
        Mesh.prototype._removeRigidBody = function () {
    ...
    function isMesh(object) {
        return undefined !== object.rigidbody;
    }
    pxsim.isMesh = isMesh;
})(pxsim || (pxsim = {}));
(function (pxsim) {
...
(function (pxsim) {
    var PhysicsWorld = (function (_super) {
        ...
        PhysicsWorld.prototype.addRigidBody = function (btbody) {
            this._btworld.addRigidBody(btbody);
        };
        PhysicsWorld.prototype.removeRigidBody = function (btbody) {
